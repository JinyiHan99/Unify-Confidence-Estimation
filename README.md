...
1. we provide the training data on the GSM8K, CSQA and TrivalQA dataset, you can find on the fold `/data/UCE/XX/confData. The file LlaMA-7B.json is generated by LLama27b`
